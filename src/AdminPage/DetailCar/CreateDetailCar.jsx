    ...
    try {
      const res = await fetch(
        "https://cnpm-api-thanh-3cf82c42b226.herokuapp.com/api/CreateDetailCar",
        {
          ...
          body: JSON.stringify({
            TenHangXe: detailCar.TenHangXe,
            TenChuSoHuu: detailCar.TenChuSoHuu,
            SoHanhLyToiDa: detailCar.SoHanhLyToiDa,
            BienSoXe: detailCar.BienSoXe,
            CongTy: detailCar.CongTy,
            SDT_TaiXe: detailCar.SDT_TaiXe,
            SoGheToiDa: detailCar.SoGheToiDa,
            SoTien_1km: detailCar.SoTien_1km,
      ...
      <div className="pt-4 flex justify-center">
        <div className="w-1/2">
          ...
          <div className="flex justify-center">
            ...
            <Link className="px-4 py-4" to={`/ListDetailCar`}>
